                ...
                <table class="table" style="color:#1d1248;">
                  <thead >
                    <tr style="background-color:#F8E08E;">
                      <th scope="col" style="text-align: center;"><b>Item</b></th>
                    </tr>
                  </thead>
                  <tbody style="background-color: white">
                    <td scope="row">
                      <h5 style="text-align: center;margin-bottom:5%;margin-top:5%;"><b>{{$only->nomeitem}}</b></h5>
                      <div class="" style="padding-top: 5%;padding-bottom: 10%;margin-right:10%;margin-left:10%;"><hr style="margin-top: -10%;"><br>
                        <h6>Preço : {{$only->precoitem}} €</h6>
                        <h6>Descrição : {{$only->descriitem}}</h6>
                      </div>
                    </td>
                  </tbody>
                </table>
