                        ...
                        <table class="table" style="color:#1d1248;">
                          <thead >
                            <tr style="background-color:#F8E08E;">
                              <th scope="col" style="text-align: center;"><b>Editar Item</b></th>
                            </tr>
                          </thead>
                          <tbody style="background-color: white">
                            <td scope="row">
                              <i class="fas fa-pen" style="font-size: 65px;margin-left:32.5%;margin-right:32.5%;margin-top:5%;margin-bottom:5%;"></i>
                              <div class="" style="padding-top: 5%;padding-bottom: 2%;margin-right:10%;margin-left:10%;">
                                
                                <form action="/items/{{$only->id}}" method="POST" enctype="multipart/form-data">
                                  @csrf
                                  @method('put')
                                <input type="text" class="form-control" aria-label="Username" aria-describedby="basic-addon1" name="nomeitem" id="nomeitem" placeholder="Nome" value="{{$only->nomeitem}}"><br>
                                      <textarea class="form-control" aria-label="With textarea" name="descriitem" id="descriitem" placeholder="Descrição" >{{$only->descriitem}}</textarea> <br>
                                      <input type="number" class="form-control" name="precoitem" id="precoitem" value="{{$only->precoitem}}"  aria-label="Username" aria-describedby="basic-addon1"> <br>
