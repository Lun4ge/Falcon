                ...
                <table class="table" style="color:#1d1248;">
                  <thead >
                    <tr style="background-color:#F8E08E;">
                      <th scope="col" style="text-align: center;"><b>Editar Utilizador</b></th>
                    </tr>
                  </thead>
                  <tbody style="background-color: white">
                    <td scope="row">
                      <i class="fas fa-user-edit" style="font-size: 65px;margin-left:32.5%;margin-right:32.5%;margin-top:5%;margin-bottom:5%;"></i>
                      <div class="" style="padding-top: 5%;padding-bottom: 2%;margin-right:10%;margin-left:10%;">
                      <form method="POST" action="/users/{{$only->id}}" enctype="multipart/form-data"> 
                      @csrf
                      @method('put') 
                  <input type="text" class="form-control" name="name" id="name" placeholder="Username" value="{{$only->name}}"  style="margin-bottom: -3%;"><br>
                  <input type="text" class="form-control" name="email" id="email" placeholder="Email" value="{{$only->email}}"  style="margin-bottom: -3%;"><br>
                  <input type="password" class="form-control" name="password" id="passwordedit" placeholder="Password" value="">

                  <div class="form-check" style="vertical-align: middle;">
                    <input class="" style=" " type="checkbox" name="mostrar" id="mostrar" onclick="myFunctionEdit()">
