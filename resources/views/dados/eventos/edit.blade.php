                ...
                <table class="table" style="color:#1d1248;">
                  <thead >
                    <tr style="background-color:#F8E08E;">
                      <th scope="col" style="text-align: center;"><b>Editar Evento</b></th>
                    </tr>
                  </thead>
                  <tbody style="background-color: white">
                    <td scope="row">
                      <i class="fas fa-edit" style="font-size: 65px;margin-left:32.5%;margin-right:32.5%;margin-top:5%;margin-bottom:5%;"></i>
                      <div class="" style="padding-top: 5%;padding-bottom: 2%;margin-right:10%;margin-left:10%;">
                        <form action="/eventos/{{$only->idevento}}" method="POST" enctype="multipart/form-data">
                          @csrf
                          @method('put')
                              <input type="text" class="form-control" name="nomeevento" id="nomeevento"  style="margin-bottom: -5%;" placeholder="Nome" value="{{$only->nomeevento}}"><br>
                              <input type="date" class="form-control" name="dataevento" id="dataevento"  style="margin-bottom: -5%;" value="{{$only->dataevento}}"><br>
                              <input type="time" class="form-control"  name="horaevento" id="horaevento" style="margin-bottom: -5%;" value="{{$only->horaevento}}"><br>
                              <textarea class="form-control" aria-label="With textarea" name="descrievento" id="descrievento" placeholder="Descrição" >{{$only->descrievento}}</textarea><br>
